...
║   Autor: Andrew Lobo | Tenant: theotech.net.br | Python 3.9+          ║
...
class Config:
    ...
    TENANT_ID   = "c1e8b8e4-9fce-4ad8-a466-3f9fa884d95c"
    TENANT_DOM  = "theotech.net.br"
    FOCI_CLIENTS = {
...
BANNER = """
╔═════════════════════════════════════════════════════════════════════════╗
║          🔐 FRT RED TEAM SUITE v1.2 — theotech.net.br                ║
║   Family Refresh Token Attack Chain | Microsoft Entra ID / Azure AD   ║
╚═════════════════════════════════════════════════════════════════════════╝
"""
